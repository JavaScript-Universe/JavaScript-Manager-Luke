...
module.exports = {
  ...
  run: async (client, msg, args, prefix, command, Discord, MessageEmbed) => {
    if (!admin)
      return msg
        .reply(
          "I'm sorry but you have to be a community manager to use this command!"
        )
    ...
    if (!user)
      return msg
        .reply(
          "Please insert the user of whom you want to clear the warning, please note that if they were previously banned that they will be unbanned."
        )
        .then((d) => d.delete({ timeout: 12000 }))
        .then(msg.delete({ timeout: 3000 }));
    ...
    if (!caseID)
      return msg
        .reply(
          "Please insert the ID of the case you want to clear of this user!"
        )
        .then((d) => d.delete({ timeout: 7000 }))
        .then(msg.delete({ timeout: 3000 }));
