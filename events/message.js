...
module.exports = async (client, message) => {
  ...
  moderation = client.guilds.cache
    ...
    ? client.guilds.cache
        .get("812011009682178089")
        .member(message.member.id)
        .roles.cache.has("812011009682178094")
    : false;
  support = client.guilds.cache
    .get("812011009682178089")
    .member(message.member.id)
    ? client.guilds.cache
        .get("812011009682178089")
        .member(message.member.id)
        .roles.cache.has("812011009682178093")
    : false;
  staff = client.guilds.cache
    .get("812011009682178089")
    .member(message.member.id)
    ? client.guilds.cache
        .get("812011009682178089")
    ...
    : false;
  admin = client.guilds.cache
    .get("812011009682178089")
    .member(message.member.id)
    ? client.guilds.cache
        .get("812011009682178089")
        .member(message.member.id)
        .roles.cache.has("812011009682178096")
    : false;
  ...
  if (
    client.guilds.cache
      .get("812011009682178089")
      .members.cache.some((m) => m.id == msg.author.id)
  ) {
  ...
  if (message.mentions.roles.has("720788623376646175")) {
    const role = client.guilds.cache
      ...
      .roles.cache.get("720788623376646175");
