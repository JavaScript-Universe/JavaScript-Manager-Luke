...
module.exports = async (client, oldMessage, newMessage) => {
    ...
    if (/(https?:\/\/)?(www\.)?(discord\.(gg|io|me|li)|discordapp\.com\/invite)\/.+[a-zA-Z]/g.test(msg.content)) {
        if (staff) return;
        if (msg.guild.id == '757759707674050591') return;
    ...
    // Anti swear filter
    const arr = ['python', 'fuck', 'bitch', 'nigger', 'dick', 'asshole', 'nigga', 'fack', 'idiot', 'fucker', 'bitches', 'cum', 'penis', 'vagina', 'pussy', 'fucking', 'facking', 'bbc', 'cock', 'sex'];
