...
module.exports = async (client, oldMessage, newMessage) => {
    ...
    moderation = client.guilds.cache.get('812011009682178089').member(msg.member.id) ? client.guilds.cache.get('812011009682178089').member(msg.member.id).roles.cache.has('757768007370932254') : false;
    support = client.guilds.cache.get('812011009682178089').member(msg.member.id) ? client.guilds.cache.get('812011009682178089').member(msg.member.id).roles.cache.has('757768012618006569') : false;
    staff = client.guilds.cache.get('812011009682178089').member(msg.member.id) ? client.guilds.cache.get('812011009682178089').member(msg.member.id).roles.cache.has('757764284779593738') : false;
    admin = client.guilds.cache.get('812011009682178089').member(msg.member.id) ? client.guilds.cache.get('812011009682178089').member(msg.member.id).roles.cache.has('757762082929377281') : false; 
